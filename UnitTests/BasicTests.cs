...
namespace UnitTestProject1
{
    ...
    public class BasicTests
    {
        ...
        public void RemoveEmpty()
        {
            ...
            Assert.ThrowsException<KeyNotFoundException>(() => tree.Remove(20));
        }
        ...
        [TestMethod]
        public void RemoveIntW2Children()
        {
            BinarySearchTree<int> tree = new BinarySearchTree<int>();
            tree.Add(8, 9);
            tree.Add(10, 11);
            ...
            tree.Add(23, 24);
            tree.Remove(10);
            Assert.AreEqual(23, tree.GetNode(9).Parent.Value);
            Assert.AreEqual(23, tree.GetNode(8).Right.Value);
        }

        [TestMethod]
        public void RemoveIntW2Children2()
        {
            BinarySearchTree<int> tree = new BinarySearchTree<int>();
            tree.Add(8, 9);
            tree.Add(10, 11);
            ...
            tree.Add(23, 24);
            tree.Remove(6);
            Assert.AreEqual(8, tree.GetNode(5).Parent.Value);
            Assert.AreEqual(8, tree.GetNode(8).Left.Value);
        }
